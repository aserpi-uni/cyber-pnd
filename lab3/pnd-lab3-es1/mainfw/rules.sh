...
iptables -I FORWARD -i eth0 -s 100.64.0.0/16 -j DROP
iptables -I INPUT -i eth0 -s 100.64.0.0/16 -j DROP
iptables -I FORWARD -i eth1 ! -s 100.64.6.0/24 -j DROP
iptables -I INPUT -i eth1 ! -s 100.64.6.0/24 -j DROP
iptables -I FORWARD -i eth2 -s 100.64.6.0 -j DROP
iptables -I INPUT -i eth2 -s 100.64.6.0 -j DROP
iptables -I FORWARD -i eth2 -s 100.64.254.1 -j DROP
iptables -I INPUT -i eth2 - 100.64.254.1 -j DROP
